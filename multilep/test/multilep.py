...
inputFile       = "file:///user/wverbeke/CMSSW_9_2_4/src/heavyNeutrino/multilep/test/pickevents.root"
nEvents         = 1000
...
#MET collection needs to be cleaned of slew rate and spurious muons for 2016
